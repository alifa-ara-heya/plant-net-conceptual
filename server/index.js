...
async function run() {
  try {
    ...
    app.post('/users/:email', async (req, res) => {
      ...
      const query = { email }; //same as const query = { email: email };
      const user = req.body;
      ...
      // const result = await usersCollection.insertOne(user);//this is enough, the following line is for fun, like when the user logged in first
